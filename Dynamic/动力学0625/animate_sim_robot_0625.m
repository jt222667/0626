function animate_sim_robot_0625(varargin)
...
opts.OutputFile = fullfile(fileparts(mfilename('fullpath')), 'robot_motion.gif');
opts.FrameStep = [];
opts.FrameRate = 30;
opts.PlaybackSpeed = 2;
opts.MaxFrames = 600;
opts.LoopCount = 1;
opts.TimeRange = [];
