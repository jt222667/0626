...
static cell_wrap_1 ab_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u,
...
static real_T (*cb_emlrt_marshallIn(const emlrtStack *sp,
...
static real_T (*db_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u,
...
static cell_wrap_0 y_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u,
                                      const emlrtMsgIdentifier *parentId);
                                    ...
                                    const char_T *identifier))[7]
{
  ...
  thisId.fParent = NULL;
  thisId.bParentIsCell = false;
  y = db_emlrt_marshallIn(sp, emlrtAlias(nullptr), &thisId);
...
static void r_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u,
                               const emlrtMsgIdentifier *parentId, real_T y[49])
{
...
static void tb_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
                                const emlrtMsgIdentifier *msgId, real_T ret[49])
{
  ...
  emlrtCheckBuiltInR2012b((emlrtConstCTX)sp, msgId, src, "double", false, 2U,
                          (const void *)&dims[0]);
  r = (real_T(*)[49])emlrtMxGetData(src);
  for (i = 0; i < 49; i++) {
    ret[i] = (*r)[i];
  }
  emlrtDestroyArray(&src);
                       ...
                       const mxArray *plhs[3])
{
  ...
  q0 = cb_emlrt_marshallIn(&st, emlrtAlias(prhs_copy_idx_2), "q0");
  qd0 = cb_emlrt_marshallIn(&st, emlrtAlias(prhs_copy_idx_3), "qd0");
