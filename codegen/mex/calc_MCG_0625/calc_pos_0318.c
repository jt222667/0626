...
void calc_pos_0318(const emlrtStack *sp, const real_T LP_module[9],
                   real_T LP_num_q, const real_T LP_align[9],
                   const real_T LP_BB[9], const real_T LP_Rd[90],
                   const real_T LP_Pp[30], const real_T LP_Pd[30],
                   const real_T LP_RBcp[27], const real_T LP_PBcp[9],
                   const real_T LP_T_L[160], const char_T LP_J_type[9],
                   const real_T LP_SN[9], struct2_T *SV)
{
  ...
  for (b_i = 0; b_i < i; b_i++) {
    ...
    if (d == 0.0) {
      ...
      if (d != 0.0) {
        ...
        i1 = (int32_T)d;
        if ((i1 < 1) || (i1 > 9)) {
          emlrtDynamicBoundsCheckR2012b(i1, 1, 9, &lb_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        if (LP_J_type[i1 - 1] == 'R') {
          Cz_tmp = d * 3.0;
          for (i2 = 0; i2 < 3; i2++) {
            ...
            b = ((c_Cz_tmp < 1.0) || (c_Cz_tmp > 27.0));
            if (b) {
              emlrtDynamicBoundsCheckR2012b((int32_T)c_Cz_tmp, 1, 27,
            ...
            if (b) {
              emlrtDynamicBoundsCheckR2012b(A_I_BB_tmp, 1, 27, &nb_emlrtBCI,
                                            (emlrtConstCTX)sp);
            }
      ...
      if (guard1 && (d != 0.0)) {
        ...
        if ((Cz_tmp_tmp < 1) || (Cz_tmp_tmp > 9)) {
          emlrtDynamicBoundsCheckR2012b(Cz_tmp_tmp, 1, 9, &mb_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        if (LP_J_type[Cz_tmp_tmp - 1] == 'L') {
          ...
          for (i2 = 0; i2 < 3; i2++) {
            ...
            if (b) {
              emlrtDynamicBoundsCheckR2012b((int32_T)Cz_tmp, 1, 27,
            ...
            if (b) {
              emlrtDynamicBoundsCheckR2012b(c_A_I_BB_tmp, 1, 27, &ob_emlrtBCI,
                                            (emlrtConstCTX)sp);
            }
